...
const User = () => {
  ...
  return (
    <div className="flex items-center gap-2">
        <img src={currentData?.avatar ? blobToBase64(currentData?.avatar) : anonAvatar} alt="avatar" className="w-10 h-10 rounded-full object-cover border border-white shadow-md"/>
