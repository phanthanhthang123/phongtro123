        ...
        <div className="py-4 border border-red-600 flex flex-col gap-8 flex-auto">
          ...
          <div className='w-full'>
              ...
              <div className="w-full">
                <label 
                  htmlFor="file" 
                  className="w-full rounded-md h-[200px] my-4 items-center flex flex-col gap-1 justify-center border-gray-400 border-dashed border-2 bg-white cursor-pointer"
                >
